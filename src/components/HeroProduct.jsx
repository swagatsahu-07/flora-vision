    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl sm:text-3xl font-normal tracking-wide">
            Aglaonema plant
          </h2>
        ...
        <button className="px-8 sm:px-12 py-2.5 sm:py-3 rounded-xl text-base sm:text-xl border-2 border-white/80 hover:bg-white/10 transition-all">
          Buy Now
        </button>

        <div className="flex justify-center items-center gap-2.5 mt-10 sm:mt-15 mb-5">
